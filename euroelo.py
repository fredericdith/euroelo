...
if selected_teams:
    for team in selected_teams:
        ...
        #display_data = team_data[['Date', 'Opponent', 'HomeAway', 'EloRating', 'Multiplier', 'Delta']] #shows multiplier
...
# --- Narrative presets ---
st.markdown("---")
st.header("Narrative presets (⚠️ VERY EXPERIMENTAL ⚠️)")
...
narratives = {
    ...
    "The 1950+ elite group 🔝": {
        "teams": ["Real Madrid", "Barcelona", "Liverpool", "Bayern Munich", "Man City"],
        "start_date": datetime.date(2014, 8, 1),
        "end_date": datetime.date.today(),
        "description": "Only 5 clubs have crossed the 1950 Elo rating in the past 10 years - and it happened just 8 times. This can be seen as the truly elite tier of European football (note: the dataset is missing all of the the 2016-17 UCL, so it can be assumed that Madrid went over 1950 at the end of this season too).",
    "markers": [
