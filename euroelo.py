...
narratives = {
    ...
    "The 1950+ elite group 🔝": {
        ...
        "end_date": datetime.date.today(),
        "description": "Only 5 clubs have crossed the 1950 Elo rating in the past 10 years - and it happened just 9 times. This can be seen as the truly elite tier of European football.",
    "markers": [
