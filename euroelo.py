...
st.header(f"Current Top 10 (as of {formatted_date})")
latest_before_date = (
...
narratives = {
    ...
    "Arteta might be cooking ⬜️🟥🧑‍🍳": {
        "teams": ["Arsenal"],
        "start_date": datetime.date(1996, 8, 1),
        "end_date": datetime.date.today(),
        "highlight_period": (datetime.date(2019, 12, 20), datetime.date.today()),
        "description": "On 20 December 2019, Arteta was appointed head coach at his former club Arsenal. Five years later, the club might be the best it's ever been since the end of the Wenger era (1996-2018).",
    },
