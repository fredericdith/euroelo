...
narratives = {
    ...
    "The 1950+ elite group 🔝": {
        ...
        "end_date": datetime.date.today(),
        "description": "Only 5 clubs have crossed the 1950 Elo rating in the past 10 years - and it happened just 10 times. This can be seen as the truly elite tier of European football.",
    "markers": [
            ...
            ("Bayern Munich", datetime.date(2021, 12, 17)),
            ("Man City", datetime.date(2021, 5, 4)),
            ("Liverpool", datetime.date(2022, 5, 3)),
            ("Man City", datetime.date(2023, 9, 23)),
